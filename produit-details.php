...
$result = mysqli_query($db, "SELECT * from image WHERE type='seconde' and produit_id ='$id'");
    ...
    <div class="rn-new-items rn-section-gapTop">
        <div class="container">
            <div class="row mb--30 align-items-center">
                <div class="col-12">
                    <h3 class="title mb--0" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Other products</h3>
                </div>
            </div>
            <div class="row g-5">
                <?php

$rslt = mysqli_query($db, "SELECT * from user u,produit p WHERE u.id = p.user_id limit 5");
